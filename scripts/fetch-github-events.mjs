...
if (!token) {
  console.warn("GH_EVENTS_TOKEN not set — writing empty events file");
  mkdirSync("assets", { recursive: true });
  writeFileSync("assets/github-events.json", "[]");
  process.exit(0);
}
...
mkdirSync("assets", { recursive: true });
writeFileSync("assets/github-events.json", JSON.stringify(pushEvents));
console.log(`Wrote ${pushEvents.length} push events to assets/github-events.json`);
